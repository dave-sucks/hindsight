...
|---|---|---|---|---|---|---|---|---|---|
| 2026-09-24 | Catalyst Event PM | biotech (PDUFA) — **first session on the app's own calendar** | in-app calendar → Grok verify → Perplexity verify | ~35 (app 16 · tape 36→1 · Grok 12 · Perplexity 6) | **8** → **6** after verification | **5** | **1** *(4 writers FAILED — DAV-313)* | — | **The app found every candidate; the outside layer found none but killed two false ones** (NUVB approved early with no 8-K; PTCT's "filing quote" was invented — DAV-314). Grok's cold sweep returned 9 past events of 12. Only EXEL exists, unpriced, event 2027-03-03. Raw: `raw/2026-09-25-CATALYST-grok.md`, `-perplexity.md`. Review: `discovery-reviews/2026-09-25-CATALYST.md`. |
