...
| SEC filings trigger via EDGAR (`SEC_EVENT`) | **Built** | Account rule on every held and watched name; red on a holding wakes a tactical run the same day. Stock page Filings tab and the thesis sheet line built. See `SEC_FILINGS.md` §10. |
