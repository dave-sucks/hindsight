...
export const { GET, POST, PUT } = serve({
  ...
  functions: [
    ...
    indicatorSnapshot,
    // The V3 Intelligence jobs (market sweep, portfolio monitor, domain
    // monitor, signal router) and their cleanup + backfill were deleted
    // 2026-09-15. The Signal / Monitor / route tables are kept as history.
    //
