...
// The route stays so Resend gets a clean 200 and stops retrying — there is
// no signature check because nothing is acted on. Stop the forward at
// Resend too, so the mailbox stops paying for delivery.
