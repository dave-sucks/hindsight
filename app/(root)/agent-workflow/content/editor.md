...
For fence changes and archetype shifts, the Editor starts from the analyst's current config and checks the proposed fence against real names on today's tape before suggesting anything.
