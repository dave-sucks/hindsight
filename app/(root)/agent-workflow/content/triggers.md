...
1. **Each analyst's sell rules, in its style.** Every holding inherits the sell rules of the analyst that owns it — you edit them on that analyst's Triggers tab. The **PEAD Specialist** gets room: review at +10% and −12%, and a 12% trail that only switches on once it has been up 10%. The **Secular Compounder** only sells automatically on a 25% give-back — a 15% give-back or a close under the 200-day is a question, not a sale. The **Catalyst Event PM** reviews at −10%; its stop and the event decide the exit. Your account adds what applies to everyone: add prompts on a ±7% day, a weekly review, and the earnings reviews.
