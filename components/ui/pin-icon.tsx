// Pin icon — the app's pin glyph, in two states.
//
// One shape, two states, nothing else: `filled` = pinned, default = not
// pinned. The head fills; the tail stays a stroke either way, so the silhouette
// is identical between states and only the weight changes.
//
// Sized by the host (Button's `[&_svg]:size-4`), coloured by currentColor —
// same contract as the lucide icons it sits beside.
