...
export interface ThesisRowData {
  ...
  status?: string;
  /**
   * Days on this name's review clock, or null when it is on no schedule
   * (DAV-225). Renders as one small icon; a name with no clock shows
   * nothing, because "not reviewed on a schedule" is the ordinary case and
