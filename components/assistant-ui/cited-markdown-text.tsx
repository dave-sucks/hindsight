 ...
 * drop the node entirely. Walks ReactNode children — including a
 * wrapping <strong> tag — to extract the underlying text.
 */
...
const citedComponents = memoizeMarkdownComponents({
  ...
  h3: ({ className, children, ...props }) => {
    ...
    // DO NOT REMOVE — it will be needed as long as workflow-step
    // terminology appears anywhere in the system prompt.
    if (isStepLabel(children)) return null;
    return (
      <h3
        className={cn(
