...
export interface ThreadProps {
  ...
  /** Configure the rich composer (ignored when composerSlot is provided) */
  composerFeatures?: RichComposerFeatures;
  /** Use the rich composer with slash commands & ticker search */
