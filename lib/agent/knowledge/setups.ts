...
/**
 * Playbook Part F: a stock that runs this far off the buy is a likely big
 * winner — the partial sale at N R is off, and the trail manages it from
 * there. Cutting a winner in half is how a good year becomes an average one.
 */
